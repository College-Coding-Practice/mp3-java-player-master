...
public class UTS extends javax.swing.JDialog 
{
    Tugas_UTS Mp3ClassPlayer = new Tugas_UTS();
    ...
    public UTS(java.awt.Frame parent, boolean modal) 
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Play, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 100, 80));
        ...
        getContentPane().add(Background, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 130));
    ...
    public static void main(String args[]) 
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            public void run() 
            {
                UTS dialog = new UTS(new javax.swing.JFrame(), true);
